...
[CustomEditor(typeof(ConversationCreatorTest))]
public class ConversationCreatorEditorTest : Editor
{
    int oldSelection = 0;
    string oldText = "";
    ...
    public override void OnInspectorGUI()
    {
        ...
        ConversationCreatorTest conversationCreator = (ConversationCreatorTest)target;
